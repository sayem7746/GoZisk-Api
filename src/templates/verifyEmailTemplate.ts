const verifyEmail = function (otp: string, firstname: string, email: string) {
                      ...
                      <tr>
                        <td class="sm-px-24"
                          style="--bg-opacity: 1; background-color: #ffffff;  border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262;"
                           align="left">
                          <p style="font-weight: 600; font-size: 18px; margin-bottom: 0;">Dear ${firstname},</p>

                          <p style="margin: 0 0 24px;">
                            A request to create your GoZisk account was received.
                            Please use the following OTP to confirm your account and log in:
                          </p>

                          <label style="display: block; font-size: 24px; line-height: 100%; margin-bottom: 24px; --text-opacity: 1; color: #000000; text-decoration: none;">${otp}</label>
    ...
    const text = `
        Verify Email, A request to create your GoZisk account was received.
